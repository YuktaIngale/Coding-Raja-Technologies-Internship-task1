...
public class SignupThree extends JFrame implements ActionListener {
    ...
    SignupThree( String formno){
        ...
        c2= new JCheckBox("Intrnet Banking");
        ...
        c7= new JCheckBox("I Hereby declares that the above entered details are correct to the best of the my knowledge");
        ...
        submit.setBounds(120, 680, 200, 30);
        ...
        cancel.setBounds(520, 680, 200, 30);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit){
           ...
           if (c1.isSelected()){
              ...
              facility = facility + "Intrnet Banking";  
